...
//     }
// }
export default class CompleteSecurity extends React.Component<IProps> {
    public componentDidMount(): void {
        // Immediately finish the complete-security step and navigate onward
        this.props.onFinished();
    }

    public render(): React.ReactNode {
        // Nothing to show—verification is skipped
        return null;
    }
}
